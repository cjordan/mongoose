...
/*!
 * Code to handle XYZ coordinates.
 */
...
impl XYZ {
    ...
    pub fn to_enh_mwa(&self) -> ENH {
        self.to_enh(mwalib::MWA_LATITUDE_RADIANS)
    }
    ...
    pub fn rotate(&self, angle: f64) -> XYZ {
    ...
    pub fn get_baselines_mwalib(mwalib: &MetafitsContext) -> Vec<XyzBaseline> {
